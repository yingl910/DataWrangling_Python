'''This is an example of using xlrd module parsing excel file'''

#xlrd is 0-based indexing
#in excel format, dates are represented as floating numbers
...
def parse_file(datafile):
    ...
    print(sheet.col_values(3, start_rowx=1, end_rowx=4)) #not including row4
